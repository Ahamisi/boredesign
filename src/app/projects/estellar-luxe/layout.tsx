...
export const metadata: Metadata = {
  title: 'Estellar Luxe is the new benchmark for elegance, comfort, and smart investing in Yaba',
  description: 'Discover Estellar Luxe, Estellar Luxe stands tall as the first building in the area to feature an apartment elevator, setting a new standard for luxury and convenience',
  ...
  openGraph: {
    ...
    url: 'https://bopropertiesng.com/projects/estellar-luxe',
