...
const ProjectRioPage: React.FC = () => {
  ...
  const rioProject = {
    ...
    sliderImages: [
      { id: '1', src: '/projects/estellar-prime/estellar-prime.jpg', alt: 'Estellar Prime Exterior' },
    ],
    plans: [
      {
        id: 'self-con',
        ...
        type: 'Self-Con (20 years)',
        size: '17sqm',
        price: '₦11,000,000',
        initialDeposit: '₦5,500,000',
        paymentDuration: '6months',
        features: [
          {text: 'Water Heater'},
          {text: 'Full Tiling'},
          {text: 'Kitchen Cabinets'},
          {text: 'Alexa Home Automation'},
          {text: 'Standby Generator'},
          {text: 'Private Inverter'},
          {text: 'Security'},
          {text: 'Private Metre'},
          {text: 'CCTV Surveillance'},
          {text: 'POP & Screeded Walls'},
        ]
      },
      {
        id: 'mini-flat',
      ...
      },
      {
        ...
        type: 'Studio Unit (22 years)',
        size: '17sqm',
        price: '₦14,000,000',
        initialDeposit: '₦7,000,000',
        paymentDuration: '6months',
        features: [
          {text: 'Water Heater'},
          {text: 'Full Tiling'},
      ...
      },
      {
        ...
        icon: '/icons/house.svg',
        iconColor: 'text-primary-blue-300',
        type: 'Self-Con (22 years)',
        size: '33sqm',
        price: '₦24,000,000',
        initialDeposit: '₦12,000,000',
        paymentDuration: '6months',
        features: [
          {text: 'Water Heater'},
          {text: 'Full Tiling'},
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <ProjectActions 
                    ...
                    brochureUrl="/brochures/ESTELLAR-PRIME-BROCHURE.pdf" 
                />
                  {/* <a 
                    href="#contact" 
