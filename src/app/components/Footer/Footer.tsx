      ...
      <div className="container mx-auto py-12 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4 items-center">
                ...
                <a 
                  href="https://linkedin.com/company/boproperties" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
                  aria-label="LinkedIn"
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about-us" className="hover:text-white/80 transition-colors">
                  About us
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/projects/queenscourt-hostel" className="hover:text-white/80 transition-colors">
                  Queenscourt Hostel
                </Link>
              </li>
              <li>
                <Link href="/projects/primero" className="hover:text-white/80 transition-colors">
                  Primero
                </Link>
              </li>
              <li>
                <Link href="/projects/rio" className="flex items-center hover:text-white/80 transition-colors">
                  Rio
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span>
                  <a href="tel:+2348147321515" className="hover:text-white/80 transition-colors">
                    08147321515
                  </a>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  <a href="mailto:bopropertiesng@gmail.com" className="hover:text-white/80 transition-colors break-all">
        ...
        <div className="border-t border-white/20 pt-8">
          <p className="text-center text-white/70">
            © {currentYear} boproperties - Real Estate. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
