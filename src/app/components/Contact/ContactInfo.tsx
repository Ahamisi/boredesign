    ...
    <div className="w-full md:w-1/2 bg-[#053B6E] text-white rounded-lg p-8 md:p-10">
      ...
      <div className="mt-16">
        ...
        <div className="flex gap-3">
          <Link href="https://www.facebook.com/people/Ifedayo-Okungbowa/100086362133521" target='_blank' className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center">
          ...
          <Link href="https://www.instagram.com/bopropertiesng" target='_blank' className="w-10 h-10 rounded-full bg-purple-500 flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://www.twitter.com/bopropertiesng" target='_blank' className="w-10 h-10 rounded-full bg-blue-400 flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://www.instagram.com/bopropertiesng" target='_blank' className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
